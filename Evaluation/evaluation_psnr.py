# Evaluation 1: PSNR, Spurious change ratio
...
from utils.helper import add_noise_all, threshold_all, add_noise, central_difference_of_links
...
def spurious_change_ratio():
    print("Calculation Spurious change ratio: ")
    sub = "sub_1"
